...
public class UserSessionManager
{
    ...
    //Login brands
    public  static  final String KEY_IS_USER_ID_LOGIN="user id rply";
    public  static  final String KEY_IS_USER_ID_LOGIN2="user_login_profile_is_setup";
    ...
    public String isloginLoggedIn()
    {
        return pref.getString(KEY_IS_USER_ID_LOGIN, null);
    }
    /*public HashMap<String, String> isloginLoggedIn()
    {
        return  pref.getBoolean(KEY_IS_USER_ID_LOGIN, false);
    }*/
