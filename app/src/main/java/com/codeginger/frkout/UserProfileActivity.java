...
public class UserProfileActivity extends ActionBarActivity implements View.OnClickListener
{
    ...
    EditText etxtUserProfileName, etxtUserProfileDOB, etxtUserProfileAge, etxtUserProfileEmailID, etxtUserProfileLocation,Edit_login,Edit_loginPass;
    CheckBox chkUserProfileAgree;
    ImageButton btn_login;
    ImageView ivUserProfile;
    Button  btnUserProfileSaveNext,btn_login_submitted;
...
//        Log.e("list add2",String.valueOf(list_of_item.toArray()[1].toString()));
       ...
       // list_of_item.add(selection);
        ...
        //Log.e("final result",""+lst);.this,"Thanks for using Frkout", Toast.LENGTH_LONG).show();


        //   Log.e("final result2",list_of_item.toArray()[0].toString());
        //Toast.makeText(UserProfileActivity
    ...
    private class AsyncAddUserInterest extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... urls)
        {
            try
            {
               ...
               // UserProfileUrl = "http://frkout.codeginger.in/Master.svc/InsertUserProfileInterest/" + UsersId + "/" + SelectedInterestID + "/" + UsersId;
               UserProfileUrl = "http://dbfrkout1-001-site1.itempurl.com/Master.svc/InsertUserProfileInterest/" + UsersId + "/" + SelectedInterestID + "/" + UsersId;
                result = c.GetData(UserProfileUrl);
            }
            catch (Exception e)
            {
